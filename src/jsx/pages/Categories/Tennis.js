...
class GameCard extends Component {
  ...
  handelSideMenu = async (eventid, teamone, teamtwo, endtime, poolsize, bettercount, category, potentialwins, zero, one, two, boosted) => {
                    ...
                    <div className="category-body pb-4">
                      <div className="row p-3">
                        ...
                        <div className="col-4 button-row gap-2">
                          <div><ImFire fill={this.state.isboosted ? "#FF9A02" : "#8c8c8c"}/></div>
                    ...
                    {this.state.allevents.map((events) => (
                      ...
                      {Number(events.teamtwoParticipate) > 0 && Number(events.teamOneParticipate) > 0 ? <div className="col" id={`${events.id}`}>
                        <div className="card game-card overflow-hidden"
                          onClick={() => this.handelSideMenu(events.id, events.teamone, events.teamtwo, events.endtime, events.poolsize, events.BettorsCount, events.subcategory, events.potential_wins, events.zero, events.one, events.two, events.isboosted)
                          }
                        >
                          <div
                          ...
                          <div className="row p-3">
                            ...
                            <div className="col-4 button-row gap-2">
                              <div><ImFire fill={events.isboosted ? "#FF9A02" : "#8c8c8c"}/></div>
