      ...
      <Fragment>
                              ...
                              <div className="row form mt-3">
                                ...
                                <div className="col-md-4">
                                  ...
                                  <p
                                    ...
                                    className="mb-0 mt-3"
                                  >
                                    {this.state.stackvaluethree == 0 ? this.state.potential_wins: this.winningamount(Number(this.state.stackvaluetwo),Number(this.state.poolsize))}&nbsp;BETS
                                  </p>
                                </div>
                              </div>
                            </div>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <h3 className='ml-3' style={{color:"white"}}>Football</h3>
            </div>
