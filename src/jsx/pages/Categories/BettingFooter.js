    ...
    <div>
      <div className="container position-relative">
        ...
        <div className="row">
          ...
          <div className="col-4"  style={{marginTop:"3.5rem"}}>  <a href="/" target="_blank" className="mx-2">
                    {" "}
...
<div className="row" style={{marginBottom:"2rem"}}>
                <div className="col-lg-3 col-md-3 col-sm-6 col-6">
                  ...
                  <a href="/" target="_blank" className="mx-2">
                    {" "}
                    <img src={metfx} alt="" className="social-link social-link-2"  />
                  </a></div>
                  <div className="col-lg-3 col-md-3 col-sm-6 col-6">
                  <a href="/" target="_blank" className="mx-2">
                    {" "}
                  ...
                  <a href="/" target="_blank" className="mx-2">
                    {" "}
                    <img src={eighteen} alt="" className="social-link social-link-2" />
                  </a></div>
                  </div>
