                ...
                {this.state.blogs != undefined ? <div className="card game-card overflow-hidden game-news-card">
                    <div className="row image-card">
                        <div className="col-12 text-white">
                            <img src={this.state.blogs.image.full_url} width="100%" />
                        </div>
                    ...
                    <div className="row px-2 mt-2 py-1">
                        <div className="col-6">
                            ...
                            <p className="text-start">
                                Created on {this.state.blogs.created_at.substring(0,10)}
                            </p>
                        </div>
                        <div className="col-6">
                        <p className="text-start theam-text-color">
                            ...
                            <a  href="#" target='_blank' style={{textDecoration:'none'}} >  <p className="text-end">
                             <Link to={{pathname: `/blogs`, query:{id:this.state.blogs.id,updated:this.state.blogs.created_at,image:this.state.blogs.image.full_url}}}> Read  <img src={arrowRight} className="ms-3" width="20" /></Link> 
                        </p></a>
                        </div>
                    </div>
                </div>:''}
